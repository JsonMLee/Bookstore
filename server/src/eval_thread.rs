...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    for num_clients in 1..=20 {
        let mut handles = vec![];
        let num_requests = 5000 / num_clients;
        ...
        file.write_all(format!("{}, {}, {}, {}\n", num_clients, time_start, time_end, time_diff.num_microseconds().unwrap_or(time_diff.num_milliseconds() * 1000) % 1_000_000).as_bytes()).await?;
